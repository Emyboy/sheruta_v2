            ...
            <div className="container">
						<div className="row align-items-center">
							<div className="col-lg-6 col-md-7">
								<h3 className="text-light">What People Say?</h3>
										...
										<Carousel.Item>
											<div aria-live="polite" className="slick-list draggable">
												<div className="slick-track" role="listbox">
													<div className="item slick-slide slick-cloned" style={{ width: "390px" }} tabindex="-1" role="option" aria-describedby="slick-slide04" data-slick-index="-1" aria-hidden="true">
